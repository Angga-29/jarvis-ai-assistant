...
class ChatMessage(BaseModel):
    role: str
    # Accepts either a plain string (normal text chat) or an OpenAI-style
    # content-parts list (for vision requests: [{"type":"text",...},
    # {"type":"image_url",...}]) — parsed further in routes._to_messages().
